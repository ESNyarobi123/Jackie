...
<head>
    ...
    <style>
        ...
        .app-sidebar {
            width: 280px;
            background: linear-gradient(180deg, rgba(248,249,250,.95), rgba(248,249,250,.88));
            ...
            scrollbar-color: rgba(30,41,59,.2) transparent;
        }

        /* Hide scrollbar completely on sidebar */
        ...
        /* Ensure sidebar is scrollable but hides scrollbar */
        .app-sidebar {
            overflow-y: scroll;
            scrollbar-width: none;
            -ms-overflow-style: none;
        ...
        .nav-item {
            ...
            text-decoration: none;
            font-size: .9375rem;
            transition: all .2s ease, padding .3s ease;
            cursor: pointer;
