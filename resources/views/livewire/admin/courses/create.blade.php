<div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-[var(--color-smoke)]">Create course</h1>
            <p class="text-sm text-[rgba(30,41,59,0.65)] mt-1">Set up course basics, pricing, and publishing.</p>
        </div>

        <div class="flex gap-2 shrink-0">
            <flux:button variant="ghost" href="{{ route('admin.courses.index') }}" wire:navigate>
                Back
            </flux:button>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 glass-card p-6 glass-soft-shadow space-y-5">
            <flux:field>
                ...
                <flux:input wire:model.live="title" placeholder="e.g. English for Beginners" />
                <flux:error name="title" />
            </flux:field>

            <flux:field>
                <flux:label>Slug</flux:label>
                <flux:input wire:model.blur="slug" placeholder="english-for-beginners" />
                <flux:error name="slug" />
            </flux:field>

            <flux:field>
                <flux:label>Excerpt</flux:label>
                <flux:textarea wire:model.blur="excerpt" rows="3" placeholder="Short summary shown in lists..." />
                <flux:error name="excerpt" />
            </flux:field>

            <flux:field>
                <flux:label>Description</flux:label>
                <flux:textarea wire:model.blur="description" rows="8" placeholder="Full description (optional)..." />
        ...
        <div class="glass-card p-6 glass-soft-shadow space-y-5">
            ...
            <div class="grid grid-cols-2 gap-3">
                <flux:field>
                    ...
                    <flux:input wire:model.blur="currency" placeholder="TZS" />
                    <flux:error name="currency" />
                </flux:field>

                <flux:field>
                    <flux:label>Price</flux:label>
                    <flux:input wire:model.blur="price_amount" inputmode="decimal" placeholder="0.00" />
            ...
            <flux:field>
                ...
                <p class="text-xs text-[rgba(30,41,59,0.55)] mt-1">
            ...
            @if($has_free_trial)
                <flux:field>
                    ...
                    <flux:input type="number" wire:model.blur="free_trial_days" min="1" max="365" placeholder="7" />
