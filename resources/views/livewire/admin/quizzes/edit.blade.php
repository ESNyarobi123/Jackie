<div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div class="min-w-0">
            <h1 class="text-2xl font-bold text-[var(--color-smoke)]">Edit quiz</h1>
            <p class="text-sm text-[rgba(30,41,59,0.65)] mt-1 truncate">{{ $quiz->title }}</p>
        </div>

        <div class="flex gap-2 shrink-0">
            <flux:button variant="ghost" href="{{ route('admin.quizzes.show', $quiz) }}" wire:navigate>
                Cancel
            </flux:button>
    ...
    <div class="glass-card p-6 glass-soft-shadow space-y-5 max-w-3xl">
        ...
        <flux:field>
            ...
            <flux:select wire:model.live="lesson_id">
