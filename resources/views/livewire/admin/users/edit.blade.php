<div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div class="min-w-0">
            <h1 class="text-2xl font-bold text-[var(--color-smoke)]">Edit user</h1>
            <p class="text-sm text-[rgba(30,41,59,0.65)] mt-1 truncate">{{ $user->email }}</p>
        </div>
    ...
    <div class="glass-card p-6 glass-soft-shadow space-y-5 max-w-3xl">
        ...
        <flux:field>
            ...
            <flux:input type="password" wire:model.blur="password" placeholder="Leave blank to keep current password" />
